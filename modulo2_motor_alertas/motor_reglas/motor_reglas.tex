...
\begin{enumerate}
  ...
  \item \textbf{Decide si vale la pena alertar:} toma la lluvia máxima esperada en una ventana corta (por defecto unas 2 horas). Si está \textbf{por debajo} del umbral de \emph{esa} zona, no molesta al equipo: no hay alerta.
